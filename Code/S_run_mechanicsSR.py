...
#    symmetry_plus_result[0] = (999,) + symmetry_plus_result[0]   Error 'tuple' object does not support item assignment
    ...
    idx_min = idx_min = np.argmin(np.array([symmetry_plus_result[0], symmetry_minus_result[0], symmetry_multiply_result[0], symmetry_divide_result[0], separability_plus_result[0], separability_multiply_result[0]]))
...
# Abang : original version        idx_min = np.argmin(np.array([symmetry_plus_result[0], symmetry_minus_result[0], symmetry_multiply_result[0], symmetry_divide_result[0], separability_plus_result[0], separability_multiply_result[0]]))
    ...
    if idx_min == 0:
        ...
        print('plus symmetry found',symmetry_plus_result[1],symmetry_plus_result[2])
        return PA
        ...
        print('minus symmetry found',symmetry_minus_result[1],symmetry_minus_result[2])
        return PA
        ...
        print('multiply symmetry found',symmetry_multiply_result[1],symmetry_multiply_result[2])
        return PA
        ...
        print('divide symmetry found',symmetry_divide_result[1],symmetry_divide_result[2])
        return PA
